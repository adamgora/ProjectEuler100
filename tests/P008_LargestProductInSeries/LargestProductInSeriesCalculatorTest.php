...
use App\P008_LargestProductInSeries\LargestProductInSeriesCalculator;
use PHPUnit\Framework\TestCase;

class LargestProductInSeriesCalculatorTest extends TestCase
{

    private LargestProductInSeriesCalculator $calculator;
    ...
    protected function setUp(): void
    {
        ...
        $this->calculator = new LargestProductInSeriesCalculator();
        $this->testArray = [
    ...
    {
        $this->assertEquals($expectedResult, $this->calculator->calculate($this->testArray, $testNumber));
    }
